#!/usr/bin/env node
/**
 * Test script para verificar hojas en Google Sheets
 */
...
async function testSheets() {
  try {
    ...
    console.log('🔍 Intentando leer hojas esperadas:');
    console.log('='.repeat(50));

    const expectedSheets = ['Productos', 'Config', 'Pedidos', 'Historial_Sync'];
    ...
    for (const sheetName of expectedSheets) {
      try {
        ...
        console.log(`✅ ${sheetName}: OK (${rowCount} filas)`);
      } catch (err) {
